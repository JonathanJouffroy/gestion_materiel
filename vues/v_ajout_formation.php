...
$listeFormation = $pdo->AfficherFOR();
$listeMaterielFormation = $pdo->AfficherMaterielFOR();
...
<!-- Form Name -->
<legend><center><h2><b>Ajouter un matériel de formation</b></h2></center></legend>
<br>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Type de formation</label> 
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-tasks"></i></span>
    <select name="typeformation" id="typeformation" size="1" required class="form-control">
                        <?php 
                        foreach ($listeFormation as $listeFOR)
                        {
                            ?> <option value="<?php echo $listeFOR['nom'] ?>"><?php echo $listeFOR['nom']; ?></option>
                            <?php
                        }
...
<div class="form-group">
  ...
  <select name="nom_rnmsc" id="nom_rnmsc" size="1"  class="form-control" required>
                        <?php 
                        foreach ($listeMaterielFormation as $listeMaterielFor)
                        {
                            ?> <option value="<?php echo $listeMaterielFor['nom_rnmsc'] ?>"><?php echo $listeMaterielFor['nom_rnmsc']; ?></option>
                            <?php
                        }
...
$(document).ready(function() {
        ...
        $("#ajout_mop").click(function(e)
	{
        ...
        if(nom == '' || nom_rnmsc == '' || typeformation == '' || conso == '' || quantite == '' || packaging == '' || localisation == '' || datep == '' || stockmini == '' || ida == '' )
        {
        ...
        $.post("../ajax/ajout_materiel_FOR.php",
            {
                "nom":nom,
                "nomrmsc":nom_rnmsc,
